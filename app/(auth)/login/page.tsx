  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <h2 className="text-3xl font-bold font-sora text-slate-900 dark:text-white mb-2">Welcome Back</h2>
        <p className="text-slate-500 dark:text-slate-400">Sign in to continue to Orbyt</p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <a href="#" className="text-xs text-[#273E57] dark:text-blue-400 hover:underline">Forgot password?</a>
            </div>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
      ...
      <p className="mt-8 text-center text-sm text-slate-600 dark:text-slate-400">
        ...
        <Link href="/register" className="font-medium text-[#273E57] dark:text-blue-400 hover:underline">
          Create an account
        </Link>
      </p>
    </motion.div>
