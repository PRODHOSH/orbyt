...
export const TRANSLATIONS: Record<Language, Record<string, any>> = {
  en: {
    ...
    // Footer
    "footer.subtitle": "THE INTELLIGENT CAMPUS OS",
    "footer.desc": "One campus. One intelligence layer. Bringing student academics, campus services, club recruitments, and institutional safety into a unified operating system.",
    "footer.roles": "Students • Faculty • Administration • Clubs • Campus Safety",
    "footer.copyright": "ORBYT. Built for smarter campuses.",
    "footer.modules": "Campus Modules",
    "footer.modules.1": "Core Message",
    "footer.modules.2": "Beyond Chat",
    "footer.modules.3": "Academic Intelligence",
    "footer.modules.4": "Club & Opportunities",
    "footer.modules.5": "AI Resume Studio",
    "footer.inst": "Institutional",
    "footer.inst.1": "Campus Safety Layer",
    "footer.inst.2": "Regulations & Handbooks",
    "footer.inst.3": "The Orbyt Workflow",
    "footer.inst.4": "Macro Analytics",
    "footer.inst.5": "Security & Privacy",
    "footer.dashboards": "Dashboards",
    "footer.dash.1": "Student Portal",
    "footer.dash.2": "Employee Portal",
    "footer.dash.3": "Admin Command Center",
    "footer.dash.4": "Safety Monitor",
    "footer.dash.5": "Visitor Management",
  },
  ...
  hi: {
    ...
    // Footer
    "footer.subtitle": "इंटेलिजेंट कैंपस ओएस",
    "footer.desc": "एक परिसर। एक इंटेलिजेंस लेयर। छात्र शिक्षा, परिसर सेवाएं, क्लब भर्तियां और संस्थागत सुरक्षा को एक एकीकृत ऑपरेटिंग सिस्टम में लाना।",
    "footer.roles": "छात्र • संकाय • प्रशासन • क्लब • परिसर सुरक्षा",
    "footer.copyright": "ORBYT. स्मार्ट परिसरों के लिए निर्मित।",
    "footer.modules": "परिसर मॉड्यूल्स",
    "footer.modules.1": "मूल संदेश",
    "footer.modules.2": "चैट से परे",
    "footer.modules.3": "शैक्षणिक इंटेलिजेंस",
    "footer.modules.4": "क्लब और अवसर",
    "footer.modules.5": "एआई रेज़्यूमे स्टूडियो",
    "footer.inst": "संस्थागत",
    "footer.inst.1": "परिसर सुरक्षा लेयर",
    "footer.inst.2": "नियम और हैंडबुक",
    "footer.inst.3": "ORBYT कार्यप्रणाली",
    "footer.inst.4": "संस्थागत एनालिटिक्स",
    "footer.inst.5": "सुरक्षा और गोपनीयता",
    "footer.dashboards": "डैशबोर्ड",
    "footer.dash.1": "छात्र पोर्टल",
    "footer.dash.2": "कर्मचारी पोर्टल",
    "footer.dash.3": "एडमिन कमांड सेंटर",
    "footer.dash.4": "सुरक्षा मॉनिटर",
    "footer.dash.5": "आगंतुक प्रबंधन",
  },
  ...
  ta: {
    ...
    // Footer
    "footer.subtitle": "நுண்ணறிவு வளாக இயங்குதளம் (CAMPUS OS)",
    "footer.desc": "ஒரு வளாகம். ஒரு நுண்ணறிவு தளம். மாணவர் கல்வி, வளாக சேவைகள், கிளப் சேர்க்கைகள் மற்றும் நிறுவன பாதுகாப்பை ஒருங்கிணைக்கிறது.",
    "footer.roles": "மாணவர்கள் • ஆசிரியர்கள் • நிர்வாகம் • கிளப்கள் • வளாக பாதுகாப்பு",
    "footer.copyright": "ORBYT. திறன்மிகு வளாகங்களுக்காக உருவாக்கப்பட்டது.",
    "footer.modules": "வளாக தொகுதிகள்",
    "footer.modules.1": "முக்கிய செய்தி",
    "footer.modules.2": "உரையாடலைத் தாண்டி",
    "footer.modules.3": "கல்வி நுண்ணறிவு",
    "footer.modules.4": "கிளப் & வாய்ப்புகள்",
    "footer.modules.5": "AI ரெஸ்யூம் ஸ்டுடியோ",
    "footer.inst": "நிறுவன",
    "footer.inst.1": "வளாக பாதுகாப்பு தளம்",
    "footer.inst.2": "விதிகள் மற்றும் கையேடுகள்",
    "footer.inst.3": "ORBYT செயல்முறை",
    "footer.inst.4": "பெருநிறுவன பகுப்பாய்வு",
    "footer.inst.5": "பாதுகாப்பு & தனியுரிமை",
    "footer.dashboards": "டாஷ்போர்டுகள்",
    "footer.dash.1": "மாணவர் போர்ட்டல்",
    "footer.dash.2": "பணியாளர் போர்ட்டல்",
    "footer.dash.3": "நிர்வாக மையம்",
    "footer.dash.4": "பாதுகாப்பு கண்காணிப்பு",
    "footer.dash.5": "பார்வையாளர் மேலாண்மை",
  },
};
